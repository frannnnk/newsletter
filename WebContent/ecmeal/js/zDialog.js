 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = '/canteen/picture/dialog/'; //图片路径配置
...
var Dialog = function () {
    ...
    this.HideButtonRowOK = false; //Franky
...
Dialog.prototype.create = function () {
    ...
    var html = '\
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" ' + (this.AllowSelect ? "" : "onselectstart=\'return false;\'") + ' style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 8px 20px; text-align: right; background-color:#f6f6f6;">\
                <input type="button" value="确 定" style="' + (this.HideButtonRowOK ? "display:none" : "") + '" id="_ButtonOK_' + this.ID + '"/>\
