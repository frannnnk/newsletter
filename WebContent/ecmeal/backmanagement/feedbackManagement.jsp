...
<%@ page import="hk.franks.newsletter.pojo.AdvicePojo"%>
<%@ page import="hk.franks.newsletter.pojo.AdviceResponsePojo"%>
...
<body>
	...
	<s:iterator value="adviceList" id="advicePojo">
		...
		<div class="consultation">
			<div class="user-time">
				<span class="user">${username }说：</span><span class="time">${time}</span><a href="#">回复</a>
			</div>
