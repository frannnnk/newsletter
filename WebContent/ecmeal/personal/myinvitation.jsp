	...
	<div id="main">
		...
		<div id="commentContainer">
			...
			<form action="myinvitation.action">
				<input type="text" value="" name="friendemail" id="friendemail" class="inputCmt"/><input type="image" class="submit" id="btnInv" src="<%=request.getContextPath()%>/picture/hk.franks.newsletter.common/spacer.gif"/>
