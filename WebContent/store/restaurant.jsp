...
<%@ page import="pojo.FoodCategoryPojo"%>
							...
							<div class="content_common menu_content content_menu"
								...
								<div class="catMsg">
									<s:iterator value="categoryPojoList1" id="categoryPojo"
										...
										<div
											style="color:white;float:left;margin-left:9px;cursor: url('<%=request.getContextPath()%>/picture/common/Hand-Arrow.cur'),auto;"
				...
				<div
					...
					<table>
						<tr style="height: 28px;">
							<td><img src="picture/common/saleout.jpg" />
							</td>
