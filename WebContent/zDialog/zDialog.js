 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = '/canteen/zDialog/images/'; //图片路径配置
...
var enableFrankDIY = true;
var frankDIYBorderClass = "border:5px solid #fdbe5f;border-radius:25px;background-color:#fff;"; //Work if enableFrankDIY = true
var okButtonStyle = "border:1px solid #999;outline:none;cursor:pointer;padding:5px 15px 5px 15px;background-color:#ccc;border-radius:5px";
var cancelButtonStyle = "border:1px solid #999;outline:none;cursor:pointer;padding:5px 15px 5px 15px;background-color:#ccc;border-radius:5px";
...
Dialog.prototype.create = function () {
    ...
    var html = '\
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-family: \'微软雅黑\', \'黑体\', \'Lucida Sans Unicode\', \'Lucida Grande\',sans-serif; font-size:12px; line-height:1.4;' + (""+frankDIYBorderClass+"") + '">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="13" colspan="3" height="13" style=""><div style="width: 13px;"></div><div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);" onmouseout="this.style.backgroundImage=\'url(' + IMAGESPATH + 'dialog_closebtn.png)\'" onmouseover="this.style.backgroundImage=\'url(' + IMAGESPATH + 'dialog_closebtn_over.png)\'" style="margin-top: 13px; position: relative; cursor: pointer; float: right; height: 17px; width: 28px; background-repeat:no-repeat;background-image: url(' + IMAGESPATH + 'dialog_closebtn.png);' + (this.ShowCloseButton ? "" : "display:none;") + '"></div><div style="width: 13px;"><a id="_forTab_' + this.ID + '" href="#;"></a></div></td>\
</tr>\
    <tr valign="top">\
	...
	' + (function (obj) {
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="16"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 8px 20px; text-align: right; ">\
                <input type="button" style="'+okButtonStyle+'" value="确 定" id="_ButtonOK_' + this.ID + '"/>\
                <input type="button" style="'+cancelButtonStyle+'" value="取 消" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '"/>\
              </div></td>\
          </tr>\
        </table></td>\
      <td width="13" style=""></td>\
